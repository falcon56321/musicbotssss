const language = {
   ...
   msg32: "Теперь пришло время слушать музыку на вашем Дискорд сервере с совершенно бесплатным и продвинутным интерфейсом. Музыкальный бот, поддерживающий воспроизведение музыки на многих платформах, сделает ваш сервер особенным. Создайте собственного музыкального бота: https://github.com/ati/MusicBot",
   msg33: "Бот-Команды",
